...
def shells_add_analytics(env):
  ...
  env.lfac0 = derive_Lorentz_from_proper(env.u)
  ...
  env.gFS    = env.lfac0/env.lfacFS
  env.tFS    = derive_FS_crosstime(env.beta1, env.D01, env.betaFS)
  env.D2f    = derive_shellwidth_crosstime(env.D01, env.lfac1, env.lfac0, env.lfac21)
  ...
  env.gRS    = env.lfac0/env.lfacRS
  env.tRS    = derive_RS_crosstime(env.beta4, env.D04, env.betaRS)
  env.D3f    = derive_shellwidth_crosstime(env.D04, env.lfac4, env.lfac0, env.lfac34)
...
def shells_add_radNorm(env, z=1., dL=2e28):
  ...
  env.tc = 3*me_*c_*env.lfac0/(4*sigT_*env.eint3p*env.eps_B)
  env.tcFS = 3*me_*c_*env.lfac0/(4*sigT_*env.eint2p*env.eps_B)
  ...
  env.tL0 = ((1+z)/env.T0)*env.lfac0*env.DV0*env.eps_e*env.eint3p/(Wp*env.nu0p)
  env.tL0FS = ((1+z)/env.T0FS)*env.lfac0*env.DV0FS*env.eps_e*env.eint2p/(Wp*env.nu0pFS)
  #env.tL0 = (env.eps_e*env.eint3p/(Wp*env.nu0p)) * env.lfac0*c_ * pi_*env.R0*env.D04/(env.lfac34*env.Nsh4)
  env.dV04 = 4*pi_*env.R0**2*(env.D04/env.Nsh4)
  env.dV01 = 4*pi_*env.R0**2*(env.D01/env.Nsh1)
  env.dEp0 = env.eps_e*(env.lfac34-1)*c_**2*env.lfac0*env.dV04*env.rho4/(Wp*env.nu0p)
  env.dEp0FS = env.eps_e*(env.lfac21-1)*c_**2*env.lfac0*env.dV01*env.rho1/(Wp*env.nu0pFS)
...
def get_rfscenario(env):
  ...
  lfacratio34 = (env.lfac4/env.lfac0)/(4.*env.lfac34)
  lfacratio21 = (env.lfac1/env.lfac0)/(4.*env.lfac21)
