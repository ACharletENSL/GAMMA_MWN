...
var2func = {
  ...
  "adb_TM":(derive_adiab_TM, ['rho', 'p'], []),
  "adb_Ryu":(derive_adiab_Ryu, ['rho', 'p'], []),
  "cons_adb":(derive_polytropic, ['rho', 'p'], []),
  "lfac":(derive_Lorentz, ['vx'], []),
  "u":(derive_proper, ['vx'], []),
  "ShSt_old":(derive_shockStrength, ['rho', 'p'], ['rhoscale']),
  "lfac_ud":(derive_lfac_ud, ['vx', 'vx_u'], []),
  "ShSt":(derive_lfac_ud_minus1, ['vx', 'vx_u'], []),
  "b_ud":(derive_relatvel_ud, ['rho', 'p'], ['rhoscale']),
  ...
  "eiR2":(derive_Eint_comoving_R2, ['x', 'rho', 'p'], ['R0', 'rhoscale']),
  ...
  "Lmax":(derive_Lmax, ['rho', 'vx', 'p', 'dtp'], ['rhoscale', 'eps_B', 'xi_e']),
  "Pemax":(derive_Pemax, ['rho', 'p'], ['rhoscale', 'eps_B']),
  ...
  "tc1":(derive_tc1, ['rho', 'p'], ['rhoscale', 'eps_B']),
  ...
  #"nu_m":(derive_nu_m, ['rho', 'vx', 'p'], ['rhoscale', 'psyn', 'eps_B', 'eps_e', 'xi_e', 'z']),
  "nup_m":(derive_nup_m_new, ['rho', 'vx', 'p', 'vx_u'], ['rhoscale', 'psyn', 'eps_B', 'eps_e', 'xi_e']),
  "nup_m2":(derive_nup_m_new, ['rho', 'vx', 'p', 'vx_u'], ['rhoscale', 'psyn', 'eps_B', 'eps_e', 'xi_e']),
  "nup_m_sc":(derive_nup_m_sc, ['x', 'rho', 'vx', 'p', 'vx_u'], ['R0', 'rhoscale', 'psyn', 'eps_B', 'eps_e', 'xi_e']),
  "nu_m":(derive_nu_m_new, ['rho', 'vx', 'p', 'vx_u'], ['rhoscale', 'psyn', 'eps_B', 'eps_e', 'xi_e', 'z']),
  "nu_m2":(derive_nu_m_new, ['rho', 'vx', 'p', 'vx_u'], ['rhoscale', 'psyn', 'eps_B', 'eps_e', 'xi_e', 'z']),
  "nup_M":(derive_nup_M, ['rho', 'p'], ['rhoscale', 'eps_B']),
  "nu_M":(derive_nu_M, ['rho', 'vx', 'p'], ['rhoscale', 'eps_B', 'z']),
...
units_CGS  = {
  ...
  "num":" (Hz)", "nub":" (Hz)", "nuM":" (Hz)", "inj":"", "fc":"", "tc":" (s).", "Ton":" (s)", "syn":"", "nu_M":" (Hz)", "nu_M2":" (Hz)",
