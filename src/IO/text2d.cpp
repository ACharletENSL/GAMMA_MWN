...
* @Last Modified time: 2021-04-12 13:59:57
*/
...
// A snapshot is phys<digits>.out, and NOTHING else -- see the note in text1d.cpp: the old
// substring test also matched the phys_input.ini setup.py copies into results/Last, which
// sorted last and was then parsed as cell data.
